        ...
        <svg viewBox="0 0 140 180" width="130" height="160" fill="none">
          <defs>
            <radialGradient id="lc1" cx="50%" cy="80%" r="60%">
              <stop offset="0%" stopColor="var(--calming-accent-color, #c96ccc)" stopOpacity="0.85" />
          ...
          <path d="M80 170 Q55 100 60 40 Q75 90 80 120Z" fill="var(--calming-accent-color, #c96ccc)" opacity="0.6" />
